...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained(model_args.model_name_or_path, empty_init=False,  trust_remote_code=True)
    model = AutoModel.from_pretrained(model_args.model_name_or_path, empty_init=False, trust_remote_code=True).half().cuda()
